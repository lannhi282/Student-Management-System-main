                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $row) {               ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div><a href="edit-teacher-detail.php?editid=<?php echo htmlentities($row->ID); ?>" class="btn btn-info btn-xs">Edit</a>
                                                                        <a href="manage-teachers.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-xs"> Delete</a>
                                                                    </div>
                                                                </td>
                                                            </tr><?php $cnt = $cnt + 1;
                                                                }
