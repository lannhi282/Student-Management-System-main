...
if (isset($_POST['login'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    if (!empty($_POST["remember"])) {
      ...
      setcookie("adminpassword", $_POST["password"], time() + (10 * 365 * 24 * 60 * 60));
    } else {
...
<body>
  ...
  <div class="login-container">
    <div class="login-header">
      ...
      <h1 class="login-title">Đăng nhập Quản trị viên</h1>
      <p class="login-subtitle">Quản lý toàn bộ hệ thống và người dùng</p>
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <input
            ...
            required
            value="<?php if (isset($_COOKIE["admin_login"])) {
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <input
            ...
            required
            value="<?php if (isset($_COOKIE["adminpassword"])) {
      ...
      <div class="checkbox-wrapper">
        <div class="checkbox-group">
          <input
            ...
            id="remember"
            name="remember"
            <?php if (isset($_COOKIE["admin_login"])) { ?> checked <?php } ?>>
