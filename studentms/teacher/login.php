    ...
    if ($query->rowCount() > 0) {
        ...
        if (!empty($_POST["remember"])) {
            ...
            if (isset($_COOKIE["teacher_login"])) {
                setcookie("teacher_login", "", time() - 3600);
                if (isset($_COOKIE["teacherpassword"])) {
                    setcookie("teacherpassword", "", time() - 3600);
                }
            }
        }
...
<head>
    ...
    <title>Đăng nhập Giảng viên - iViettech</title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            ...
            <p class="login-subtitle">Đăng nhập vào tài khoản giảng viên của bạn</p>
            <div class="role-badge">
                <i class="fas fa-user-graduate"></i> Giảng viên
            </div>
        </div>
        ...
        <form method="post" id="loginForm">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input
                        ...
                        required
                        value="<?php if (isset($_COOKIE["teacher_login"])) echo $_COOKIE["teacher_login"]; ?>">
                </div>
            </div>
            ...
            <div class="checkbox-wrapper">
                <div class="checkbox-group">
                    <input type="checkbox" id="remember" name="remember" <?php if (isset($_COOKIE["teacher_login"])) echo "checked"; ?>>
