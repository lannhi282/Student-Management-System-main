...
if (strlen($_SESSION['teachermsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($verify_query->rowCount() > 0) {
            ...
            echo '<script>alert("You are not authorized to add homework for this class.")</script>';
        }
    }
?>
    <!DOCTYPE html>
    ...
    <head>
        <title>Teacher Management System|| Add Homework</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="homeworkdescription" class="form-control" required='true'></textarea>
                                            </div>
                                            <div class="form-group">
